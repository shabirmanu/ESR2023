...
def conv_layer(in_channels, out_channels, kernel_size, stride=1, dilation=1, groups=1): # in * out * kernal *
...
class RFDB(nn.Module):
    def __init__(self, in_channels, distillation_rate=0.25):
        ...
        self.c1_r = conv_layer_sep(in_channels, self.rc, 3)
        self.c2_d = conv_layer(self.remaining_channels, self.dc, 1)
        self.c2_r = conv_layer_sep(self.remaining_channels, self.rc, 3)
        self.c3_d = conv_layer(self.remaining_channels, self.dc, 1)
        self.c3_r = conv_layer_sep(self.remaining_channels, self.rc, 3)
        self.c4 = conv_layer_sep(self.remaining_channels, self.dc, 3)
